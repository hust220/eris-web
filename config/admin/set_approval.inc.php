<?php
# Wasic user approval operations
...
function set_approval($userid, $username,$action, $email_flag,$reason,$oplevel){
  ...
  switch($action){
    case "Disapprove":
      ...
      $msg = "";
      $msg .= "Your user account in Eris server has not been approved due to the following reason(s): \n";
      $msg .= $reason . "\n" ;
      $msg .= "Please contact us if you have any questions \n";
      $msg .=  "Thanks for using Eris server \n";
    ...
    case "Approve":
      ...
      if ($email_flag == 0) {return(0); }
      $msg = "Congradulations! ";
      $msg .= "Your Eris user account has been approved. ";
      $msg .= "You can now log in using your username '$username' to";
      $msg .=" the Eris server ( http://eris.dokhlab.org ). \n";
      $msg .= "Please contact us if you have any questions \n";
      $msg .=  "Thanks for using Eris server \n";
      break;
    ...
    case "Suspend":
      ...
      if ($email_flag == 0) {return(0); }
      $msg = "";
      $msg .= "Your user account in Eris server has been suspended due to the following reason(s): \n";
      $msg .= $reason . "\n" ;
      $msg .= "Please contact us if you have any questions \n";
      $msg .= "Thanks for using Eris server \n";
      break;
    ...
    case "Resume":
      ...
      if ($email_flag == 0) {return(0); }
      $msg = "Congradulations! ";
      $msg .= "Your Eris user account has been resumed \n";
      $msg .= "You can now log in using your username '$username' to";
      $msg .=" the Eris server ( http://eris.dokhlab.org ). \n";
      $msg .= "Please contact us if you have any questions \n";
      $msg .=  "Thanks for using Eris server \n";
  ...
  $subject="Importance notice regarding your Eris user account";
