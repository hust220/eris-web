...
if ($_POST['subject'] && $_POST['body']){
  ...
  $query = "SELECT email,namefirst,namelast FROM $tableusers WHERE username='$name'";
  ...
  $mail_message.="\r\nfrom:".$username; 
  $mail_headers = "From:eris server\r\nReply-To:\"$namefirst $namelast\" <$useremail>\r\nX-Mailer: eris PHP script" . phpversion ();
  mail("krohotin@email.unc.edu,syin@email.unc.edu,fding@unc.edu,dokh@med.unc.edu", $mail_subject, $mail_message, $mail_headers);
